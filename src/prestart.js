...
function loadConfig(configFile) {
	...
	nconf.set('base_templates_path', path.join(nconf.get('themes_path'), 'magicforum-theme-persona/templates'));
...
function versionCheck() {
	...
	if (!compatible) {
		winston.warn('Your version of Node.js is too outdated for magicforum. Please update your version of Node.js.');
