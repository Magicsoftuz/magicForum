...
function getLatestVersion(callback) {
	const headers = {
		...
		'User-Agent': encodeURIComponent(`MagicForum Admin Control Panel/${meta.config.title}`),
	};
	...
	request('https://api.github.com/repos/magicsoftuz/magicforum/releases/latest', {
		json: true,
		headers: headers,
		timeout: 2000,
