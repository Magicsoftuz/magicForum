	...
	try {
		...
		switch (err.message) {
			case 'dependencies-out-of-date':
				winston.error('One or more of magicforum\'s dependent packages are out-of-date. Please run the following command to update them:');
				winston.error('    ./magicforum upgrade');
				break;
			case 'dependencies-missing':
				winston.error('One or more of magicforum\'s dependent packages are missing. Please run the following command to update them:');
				winston.error('    ./magicforum upgrade');
				break;
			default:
...
function printStartupInfo() {
	if (nconf.get('isPrimary')) {
		winston.info('Initializing magicforum v%s %s', nconf.get('version'), nconf.get('url'));
