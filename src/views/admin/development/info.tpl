			...
			<table class="table table-striped">
				...
				<tr>
					...
					<td class="text-center">
						{{{if info.magicforum.isPrimary}}}<i class="fa fa-check"></i>{{{else}}}<i class="fa fa-times"></i>{{{end}}} /
						{{{if info.magicforum.runJobs}}}<i class="fa fa-check"></i>{{{else}}}<i class="fa fa-times"></i>{{{end}}}
					</td>
					...
					<td>{info.git.branch}@<a href="https://github.com/magicforum/magicforum/commit/{info.git.hash}" target="_blank">{info.git.hashShort}</a></td>
