	...
	<div class="col-sm-10 col-xs-12">
		<form>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control input-lg" id="email:from_name" data-field="email:from_name" placeholder="magicforum" /><br />
			</div>
		...
		<form>
			...
			<div class="form-group">
				...
				<select class="form-control input-lg" id="email:smtpTransport:service" data-field="email:smtpTransport:service">
					<option value="magicforum-custom-smtp" style="font-weight: bold">[[admin/settings/email:smtp-transport.service-custom]]</option>
